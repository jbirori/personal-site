...
export default function Project({ data }) {
  ...
  return (
    <Project.Page>
      <Helmet>
        <title key="Tab Title">{proj.name}</title>
        <meta key="OG Title" property="og:title" content={proj.name} />
        <meta key="Twitter Title" name="twitter:title" content={proj.name} />
      </Helmet>
      <Project.ImageContainer><Project.Image src={projImage} /></Project.ImageContainer>
      <Project.ContentContainer>
        <Project.ContentTitle>{proj.name}</Project.ContentTitle>
